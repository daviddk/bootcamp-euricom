...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoRepo = (function () {
	    function TodoRepo() {
	        ...
	        this.todos = _utilJs2['default'].store('todos-jquery');
	    }

	    _createClass(TodoRepo, [{
	        key: 'add',
	        value: function add(item) {
	            this.todos.push({
	                id: _utilJs2['default'].uuid(),
	                title: item,
	                completed: false
	            });
	        }
	        ...
	        value: function store() {
	            return _utilJs2['default'].store('todos-jquery', this.todos);
	        }
	    }, {
	        key: 'toggleAll',
	        value: function toggleAll(isChecked) {
