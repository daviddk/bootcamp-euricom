...
var userKeyController = require('../controllers/userKeyController');
...
//KEY routes
//GET /api/users/keys
router.get('/:id/keys', userKeyController.findAll);

//POST /api/users/id/keys
router.post('/:id/keys', userKeyController.create);

//DELETE api/users/id/keys/name
router.delete('/:id/keys/:name', userKeyController.delete);
